...
Disclosure Pilot AI is a full-stack desktop application that demonstrates using Large Language Models to automate the drafting, compilation, and iXBRL compliance tagging of SEC Form 10-Q and Form 10-K financial reports. (See docs/Disclosure-Pilot-AI.pdf)
...
> For comprehensive documentation and visual guides, see [`docs/installation/Start-Here-Setup.docx`](https://www.google.com/search?q=docs/installation/Start-Here-Setup.docx).

**Prerequisites**

* **OS:** Windows 11
* **Python:** Version 3.13 (added to system `PATH`)
* **Node.js:** Installed and added to system `PATH`
* **PostgreSQL:** Running local or remote instance
* **Ollama:** Running service with local LLM models pre-loaded
* **Arelle GUI:** Installed
...
*Edit `.env` to set your PostgreSQL connection details and local Ollama model parameters.*
...
• Document Workspace: (stores staged report components and compiled final outputs)
